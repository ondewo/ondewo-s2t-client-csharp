...
namespace Ondewo.S2T.Client.Tests
{
    ...
    public class OndewoAuthTests
    {
        ...
        public async Task CreateBearerInterceptorAppendsTheTokenToCallMetadata()
        {
            ...
            await interceptor(new AuthInterceptorContext("https://s2t.ondewo.com", "TranscribeFile"), metadata);
        ...
        {
            AsyncAuthInterceptor interceptor = OndewoAuth.CreateBearerInterceptor(Token);
            var context = new AuthInterceptorContext("https://s2t.ondewo.com", "TranscribeFile");
